...
// Внутренние номера сотрудников — трёхзначные (100–199 и т.п.). Группа «10»
// и служебные правила «5100», «6100» под это не попадают, поэтому входящий
// засчитывается тому, кто реально ответил. Шаблон меняется PBX_EXT_RE.
